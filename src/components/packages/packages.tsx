...
const Packages = () => {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      animate="animate"
      className="container bg-[url('/hero-section/background-1.png')] bg-cover bg-center bg-no-repeat"
    >
      <div className="md:py-26 py-24 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {packages.map((pkg) => (
            <div
              key={pkg.id}
              className="space-y-8 bg-ghostWhite shadow-md rounded-xl px-16 py-6"
            >
              <div>
                <img
                  src={pkg.PkgImg}
